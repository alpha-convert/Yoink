...
def test_compile_var_passthrough():
    ...
    assert interp == compiled == [PlusPuncA()]
...
def test_compile_catr_simple():
    ...
    ys = [PlusPuncB(), CatEvA(BaseEvent(2)), CatPunc(), PlusPuncA()]
...
def test_compile_sum_inl():
    ...
    assert interp == compiled
    # Should start with PlusPuncA tag
...
def test_compile_sum_case():
    ...
    # Left injection
    xs_left = [PlusPuncA(), PlusPuncB(), CatEvA(BaseEvent(1)), CatPunc(), PlusPuncA()]
    ...
    # Right injection
    xs_right = [PlusPuncB(), PlusPuncB(), CatEvA(BaseEvent(2)), CatPunc(), PlusPuncA()]
...
def test_compile_concat_strings():
    ...
    xs = [PlusPuncB(), CatEvA(BaseEvent(1)), CatPunc(), PlusPuncA()]
    ys = [PlusPuncB(), CatEvA(BaseEvent(2)), CatPunc(), PlusPuncA()]
    zs = [PlusPuncB(), CatEvA(BaseEvent(3)), CatPunc(), PlusPuncA()]
